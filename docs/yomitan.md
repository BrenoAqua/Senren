...
| `definition`         | `{single-glossary-jitendexorg-2025-01-27-brief}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Set your primary dictionary here.                                                                         |
| `wordAudio`          | `{audio}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                             |
| `sentenceAudio`      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Leave empty.                                                                                                                    |
| `picture`            | `{clipboard-image}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |                                                                                                                             |
| `glossary`           | `{glossary}`  | Requires "Group term-reading pairs" or "Group related terms" in Result Display [(see below)](#result-display-setting). [Dictionaries I use](https://drive.google.com/drive/folders/1OgCWBif-wnN5iz8k1oi_UQdB0_niDud4?usp=sharing). |
...
| `dictionaryPreference`|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Enter `glossary` to show the glossary field first by default. Leave empty to show the `definition` field first. Use [Batch Editing add-on](https://ankiweb.net/shared/info/291119185) to update existing cards.           |
