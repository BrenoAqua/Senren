...
??? note "Click to expand CSS code"
    ...
    [data-average-frequency="true"] [data-section-type="frequencies"]:active
    .frequency-group-item:not([data-details="Average"]) {
    display: inline-block;
    }
    ...
    span.frequency-group-item:nth-child(n + 4):not([data-details="Average"]) {
    display: inline-block;
    }
...
??? note "Click to expand Popup CSS Code"
    ...
    [data-average-frequency="false"] [data-section-type="frequencies"]:active span.frequency-group-item:nth-child(n + 3):not([data-details="Average"]) {
      display: inline-block;
    }
