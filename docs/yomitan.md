...
??? note "Click to expand CSS code"
    ...
    .entry:has(.headword[data-pronunciation-categories^="atamadaka"]) {
        --pronunciation-annotation-color: var(--pitch-red);
    }

    .entry:has(.headword[data-pronunciation-categories^="heiban"]) {
        --pronunciation-annotation-color: var(--pitch-blue);
    }

    .entry:has(.headword[data-pronunciation-categories^="nakadaka"]) {
        --pronunciation-annotation-color: var(--pitch-orange);
    }

    .entry:has(.headword[data-pronunciation-categories^="odaka"]) {
        --pronunciation-annotation-color: var(--pitch-green);
    }

    .entry:has(.headword[data-pronunciation-categories^="kifuku"]) {
