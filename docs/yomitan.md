...
| `glossary`           | `{glossary}` or  | Requires "Group term-reading pairs" or "Group related terms" in Result Display [(see below)](#result-display-setting). [Dictionaries I use](https://drive.google.com/drive/folders/1OgCWBif-wnN5iz8k1oi_UQdB0_niDud4?usp=sharing). |
